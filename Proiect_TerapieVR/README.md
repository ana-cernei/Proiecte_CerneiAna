...
| Versiune | Descriere |
|----------|-----------|
| **Project_Phobia_V1** | Observare pasivă a câinelui virtual. Fără sunete sau interacțiuni. Doar acomodare vizuală. |
| **Project_Phobia_V2** | Interacțiune indirectă: un buton VR declanșează comportamente prietenoase ale câinelui. |
| **Project_Phobia_V3** | Mini-joc: apăsarea butonului → acțiuni ale câinelui + recompense vizuale (confetti, scor, stele). |
| **Project_Phobia_V4** | Interacțiune directă: utilizatorul aruncă mingea sau piaptănă câinele. Câinele răspunde cu reacții animate, fiind intergrat sistemul de recompensă anterior |
...
🔗 [Link către Google Drive – Assets și apk-urile versiunilor aplicației](https://drive.google.com/drive/folders/1qwTC4fGoUbzXw_z5jMypyvkq_D_ekL3z)

### Structura conținutului din Drive

- `Assets_V1/`, `Assets_V2/`, ... – fiecare conține folderul `Assets/` complet pentru versiunea respectivă  
- `apk_builds/` – fișiere `.apk` gata de instalare pe **Meta Quest 2**
...
2. Instalează pe cască folosind:
   ...
   - Sau terminal ADB:
     ```bash
     adb install nume_aplicatie.apk
     ```
...
- Lătrat blând: [Freesound](https://freesound.org/people/Alex_hears_things/sounds/758868/)
- Alergat: [Freesound](https://freesound.org/people/ilmari_freesound/sounds/585911/)

---

## Recompense vizuale

- Stea: [Flaticon](https://www.flaticon.com/free-icon/star_7269732)
- Inimă: [PNGTree](https://pngtree.com/freepng/beautiful-bright-red-heart_6252575.html)
